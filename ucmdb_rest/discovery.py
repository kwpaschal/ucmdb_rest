...
class Discovery:
  ...
  def createJobGroup(self, job_group):
      ...
      """
      url = f'{self.client.base_url}/discovery/discoveryprofiles'
      return self.client.session.post(url, json=job_group)
  ...
  def deleteSpecificJobGroup(self, job_group):
      ...
      """
      safe_job_group = quote(job_group)
      url = f'{self.client.base_url}/discovery/discoveryprofiles/{safe_job_group}'
  ...
  def getJobGroup(self, fields =''):
      ...
      if not fields:
          ...
          safe_fields = quote(fields)
          url = f'{self.client.base_url}/discovery/discoveryprofiles?fields={safe_fields}'
      return self.client.session.get(url)
